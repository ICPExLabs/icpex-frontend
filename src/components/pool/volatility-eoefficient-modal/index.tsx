...
const commonOptions: (VolatilityEoefficientOption & { desc: string })[] = [
  ...
  },
  {
    key: "Stable",
    value: "0",
    desc: "Results in a completely fixed price.",
  },
];
...
const VolatilityEoefficientModal = forwardRef<
  VolatilityEoefficientModalRef,
  VolatilityEoefficientModalProps
>(({ onConfirm, poolType, poolTemplate }, ref) => {
  const [open, setOpen] = useState(false);
  console.log(poolType, poolTemplate);
