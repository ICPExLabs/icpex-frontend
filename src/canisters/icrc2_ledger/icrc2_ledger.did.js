export const idlFactory = ({ IDL }) => {
  ...
  const Result_3 = IDL.Variant({ Ok: TxIndex, Err: TransferError });
  ...
  const Ledger = IDL.Service({
    ...
    icrc_plus_cycles: IDL.Func([], [IDL.Nat], ["query"]),
    icrc_plus_fee_info: IDL.Func([], [FeeInfo], ["query"]),
    icrc_plus_holders_count: IDL.Func([], [IDL.Nat], ["query"]),
    icrc_plus_logo: IDL.Func([], [IDL.Text], ["query"]),
    icrc_plus_mint_on: IDL.Func([], [IDL.Bool], ["query"]),
    icrc_plus_owner: IDL.Func([], [IDL.Principal], ["query"]),
    icrc_plus_set_owner: IDL.Func(
