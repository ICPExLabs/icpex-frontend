...
const features = [
  ...
  },
  {
    ...
    desc: "In addition to the ICP Blockchain, ICPEx will also continue to integrate ETH, BSC, HECO and other excellent blockchains. ICPEx will bring sufficient liquidity to the decentralized financial network with flexible scalability and rich functionality.",
    icon: multiplePng,
    direction: "ltr",
  },
];
...
const sosocialPlatforms = [
  ...
  },
  {
    img: documentPng,
    name: "Whitepaper",
    src: "https://github.com/ICPExLabs/ICPEx_SNS/blob/main/ICPEx-WhitePaper3.0.md",
    width: "68px",
  },
];
    ...
    <div className={styles.guide}>
      ...
      <div className={styles.content}>
            ...
            <a rel="noopener noreferrer" href={item.url} key={index}>
              <div
                className={classNames(
                  styles["tool-item"],
                  item.soon ? styles.soon : null
                )}
              >
                <div className={classNames(styles["tool-item-icon"])}>
                  <img src={item.img} alt="icon" />
                </div>
                <div className={styles["tool-item-title"]}>{item.name}</div>
                <div className={styles["tool-item-desc"]}>{item.txt}</div>
              </div>
            </a>
          ))}
        </div>
        ...
        <div className={styles.contactText}>
          Learn more about the ICPEx project, interact with the development
          team, participate in community discussions, and express your views on
        ...
        <div className={styles["footer-content"]}>
          <div className={styles["footer-content-left"]}>
            ...
            <div className={styles.websiteInfo}>
              <span>contact@icpex.org</span>
              <div className={styles.line} />
              <div className={styles.font18}>COPYRIGHT © 2023 - 2024 ICPEx</div>
            </div>
          </div>
                  ...
                  <div className={styles["category-links"]}>
                    {links.map((link) => {
                      ...
                      return (
                        <div
                          key={label}
                          className={styles["category-links-item"]}
                        >
                          <a
                            target="_blank"
                            rel="noopener noreferrer"
